...
- procurement vendor routes for scoped profiles, private documents, project evaluations, history, and filtered CSV export
...
- Survey records and timeline are implemented, but survey media management is pending. Procurement vendor management is implemented; BOQ/material-request/warehouse operations, cash flow, profit-and-loss, Google Drive integration, and broad cross-module analytics remain pending.
