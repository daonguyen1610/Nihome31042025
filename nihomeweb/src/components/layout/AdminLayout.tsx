    ...
    () => [
      {
        ...
        label: t("nav.catalog"),
        icon: Layers,
        items: [{ to: "/admin/categories", label: t("nav.categories"), icon: FolderTree }],
      },
      {
        id: "users",
        label: t("nav.users"),
        ...
        items: [
          ...
          { to: "/admin/customer-roles", label: t("nav.customerRoles"), icon: ShieldCheck },
          { to: "/admin/online-customers", label: t("nav.onlineCustomers"), icon: Wifi },
      ...
      },
      {
        ...
        icon: Cog,
        items: [
          { to: "/admin/settings/customer", label: t("set.customer"), icon: UserCog },
          { to: "/admin/settings/general", label: t("set.general"), icon: SlidersHorizontal },
          { to: "/admin/settings/media", label: t("set.media"), icon: ImgIcon2 },
      ...
      },
      {
        ...
        items: [
          ...
          { to: "/admin/system/queue", label: t("sys.queue.title"), icon: InboxIcon },
          { to: "/admin/system/tasks", label: t("sys.tasks.title"), icon: CalendarClock },
          { to: "/admin/system/se-names", label: t("sys.se.title"), icon: LinkIcon },
