...
const schema = yup.object({
  ...
  terms: yup.bool().oneOf([true], 'You must accept the placeholder privacy policy and terms.')
})
...
const RegisterPage = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    auth.register({ email, username, password }, err => {
      if (err.email) {
        setError('email', {
          type: 'manual',
          message: err.email
      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>{`Create your ${themeConfig.templateName} access`}</TypographyStyled>
              <Typography variant='body2'>
                This starter screen comes from the full template and is ready for the next API integration pass.
              </Typography>
            </Box>
                      ...
                      label={
                        <Fragment>
                          <Typography
                            variant='body2'
                            component='span'
                            sx={{ color: errors.terms ? 'error.main' : 'text.secondary' }}
                          >
                            I agree to the{' '}
                          </Typography>
