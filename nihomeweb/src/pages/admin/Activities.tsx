  ...
  return (
    <AdminLayout>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-7">
        <div>
          <h1 className="font-display text-3xl lg:text-4xl font-extrabold tracking-tight">{t("activities.title")}</h1>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link to="/admin/activities/new" className="admin-btn-primary inline-flex items-center gap-2 px-5 py-2.5 text-sm">
          ...
          <table className="w-full text-sm">
            <thead style={{ background: "hsl(var(--admin-bg))" }}>
              <tr className="text-left">
                ...
                <th className="px-6 py-4 font-bold text-xs uppercase tracking-wider">{t("activities.col.post")}</th>
                <th className="px-6 py-4 font-bold text-xs uppercase tracking-wider">{t("activities.col.category")}</th>
                <th className="px-6 py-4 font-bold text-xs uppercase tracking-wider">{t("activities.col.author")}</th>
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-12 text-center" style={{ color: "hsl(var(--admin-muted))" }}>
                    {t("activities.empty")}
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={a.id} className="border-t hover:bg-muted/30 transition" style={{ borderColor: "hsl(var(--admin-border))" }}>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="inline-flex items-center gap-1">
                        ...
                        <Link
                          to={`/admin/activities/${a.slug}/edit`}
                          className="w-8 h-8 rounded-lg hover:bg-muted flex items-center justify-center transition"
