            ...
            <div className="space-y-3">
              {[
                ...
                <div key={key as string}>
                  ...
                  <input type={type as string} value={(draft as any)[key as string]} onChange={(e) => setDraft({ ...draft, [key as string]: type === "number" ? +e.target.value : e.target.value } as Language)} className="w-full rounded-lg px-3 py-2 text-sm bg-white border outline-none" style={{ borderColor: "hsl(var(--admin-border))" }} />
                </div>
              ))}
