...
4. The same user selects **Connect/Reconnect Google Drive**, signs in once as the approved account, and grants access. No OAuth secret or refresh token is copied into an application settings file.
