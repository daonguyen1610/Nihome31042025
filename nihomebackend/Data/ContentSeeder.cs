...
public static class ContentSeeder
{
    ...
    private static void SeedProjects(AppDbContext db)
    {
        ...
        {
            new() { Slug = "nha-may-bma", ImageUrl = "/images/upload/8e7749bb830f417184d02304c56469be.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/a9d2fcb986544158ac8f720ccdbf4936.jpg", "/images/upload/8b3682a46796474dbacf615e92f7b794.jpg" }), Name = "Nhà Máy BMA", Client = "Bảo Minh Ân Việt Nam", Location = "KCN Hựu Thạnh, Tây Ninh", Scale = "15.000 m²", Scope = "Thiết kế và Thi công", Status = "ongoing", Year = "2024", Category = "Nhà máy công nghiệp", Description = "Dự án Nhà Máy BMA là tổ hợp sản xuất hiện đại với quy mô 15.000 m², được thiết kế theo tiêu chuẩn công nghiệp quốc tế.", ChallengesJson = JsonSerializer.Serialize(new[] { "Yêu cầu tiến độ chặt chẽ trong vòng 10 tháng từ khởi công đến vận hành.", "Giải pháp kết cấu nhà xưởng nhịp lớn không cột giữa cho dây chuyền sản xuất.", "Tối ưu hệ thống thông gió và chiếu sáng tự nhiên để tiết kiệm năng lượng." }), SolutionsJson = JsonSerializer.Serialize(new[] { "Áp dụng kết cấu thép tiền chế nhịp 30m với mái lấy sáng polycarbonate.", "Thi công song song nhiều hạng mục, quản lý tiến độ bằng phần mềm BIM 4D.", "Hệ thống M&E đồng bộ, dự phòng công suất cho mở rộng tương lai 30%." }), HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "15.000 m²" }, new { label = "Thời gian", value = "10 tháng" }, new { label = "Nhịp kết cấu", value = "30 m" }, new { label = "Tiêu chuẩn", value = "ISO 9001" } }), SortOrder = 0 },
            new() { Slug = "nha-xuong-nbdc", ImageUrl = "/images/upload/f998fb835c774d238921907c0fdc0c26.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/5255a499eb754c968ab4de460caa733a.jpg", "/images/upload/60895fead1b2460d9501c478152785da.png" }), Name = "Nhà Xưởng NBDC", Client = "Công ty TNHH NBDC VN", Location = "KCN Giang Điền, Đồng Nai", Scale = "8.500 m²", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Nhà xưởng sản xuất", Description = "NICON cung cấp dịch vụ thiết kế kiến trúc và kết cấu trọn gói cho nhà xưởng sản xuất NBDC tại KCN Giang Điền.", ChallengesJson = JsonSerializer.Serialize(new[] { "Bố cục dây chuyền sản xuất phức tạp với nhiều khu vực chức năng.", "Yêu cầu tích hợp khu văn phòng điều hành và sản xuất trong cùng một khối." }), SolutionsJson = JsonSerializer.Serialize(new[] { "Phân khu rõ ràng với luồng di chuyển một chiều, giảm chéo nhau.", "Thiết kế khu văn phòng 2 tầng tích hợp với view nhìn xuống xưởng." }), HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "8.500 m²" }, new { label = "Khu chức năng", value = "5" }, new { label = "Nhân sự dự kiến", value = "200" }, new { label = "Năm", value = "2024" } }), SortOrder = 1 },
            new() { Slug = "nha-may-lhh", ImageUrl = "/images/upload/c3480218d09546318621d9a121832d84.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/bb18453303354e26a2358e337bf8338e.png", "/images/upload/0b176a622f2546259ac325db44f346e6.png" }), Name = "Nhà Máy Lâm Hiệp Hưng – Tân Toàn Phát", Client = "Lam Hiệp Hưng & Tân Toàn Phát", Location = "Tỉnh Bình Dương", Scale = "250.000 m²", Scope = "Thiết kế", Status = "ongoing", Year = "2023", Category = "Tổ hợp công nghiệp", Description = "Một trong những dự án quy mô lớn nhất NICON đã thực hiện: tổ hợp nhà máy 250.000 m².", ChallengesJson = JsonSerializer.Serialize(new[] { "Quy hoạch tổng mặt bằng quy mô siêu lớn với nhiều khối công trình.", "Đồng bộ hạ tầng kỹ thuật trên diện tích lớn." }), SolutionsJson = JsonSerializer.Serialize(new[] { "Quy hoạch theo mô-đun, dễ dàng mở rộng và thay đổi công năng.", "Hệ thống đường nội bộ thiết kế cho xe container 40 feet." }), HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Tổng diện tích", value = "250.000 m²" }, new { label = "Khối công trình", value = "12" }, new { label = "Đường nội bộ", value = "5,2 km" }, new { label = "Năm", value = "2023" } }), SortOrder = 2 },
            new() { Slug = "ttdtt-thu-duc", ImageUrl = "/images/upload/9ac1ac11fc1c4318ab5531964cd688af.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/c60883c147d54f07ad4959c9e888ee58.png", "/images/upload/ef1a415f268640e89012b50213080f22.png", "/images/upload/2a3a1e63f159424991cdcc495d41be32.png" }), Name = "Trung Tâm Thể Dục Thể Thao Thủ Đức", Client = "Thủ Thiêm Group", Location = "Thủ Đức, TP.HCM", Scale = "12.000 m²", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Công trình công cộng", Description = "Trung tâm thể dục thể thao đa năng phục vụ cộng đồng tại Thủ Đức.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "12.000 m²" }, new { label = "Nhịp mái", value = "45 m" }, new { label = "Sức chứa", value = "2.000 chỗ" }, new { label = "Năm", value = "2024" } }), SortOrder = 3 },
            new() { Slug = "noi-that-b37", ImageUrl = "/images/upload/0680511aa2634bfb9c88601eeb4f1cc2.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/61577e94fc984ef7962c60fe2bd7ab4c.jpg", "/images/upload/77beff0bf9f64265983fce9d52de754e.jpg", "/images/upload/f2f025117cf54b13a37f686cdf58b5a0.png" }), Name = "Văn Phòng B37", Client = "Nihome", Location = "Thủ Đức, TP.HCM", Scale = "1.200 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2024", Category = "Nội thất văn phòng", Description = "Thiết kế nội thất văn phòng hiện đại với phong cách tối giản, không gian mở.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "1.200 m²" }, new { label = "Sức chứa", value = "80 người" }, new { label = "Phòng họp", value = "6" }, new { label = "Năm", value = "2024" } }), SortOrder = 4 },
            new() { Slug = "nha-may-trimas", ImageUrl = "/images/upload/d9e456fcad6d4469b2afde2f339bfc9d.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/d3ad2edecc9c495e9a4424016292ccc9.png", "/images/upload/bc825439819740f7bb9b65399f8b020a.png", "/images/upload/e5730ec2665e4739a935c9491bf910bd.png" }), Name = "Nhà Máy Trimas Việt Nam", Client = "Rieke Packaging Vietnam Co., Ltd", Location = "VSIP IIA, TP.HCM", Scale = "10.000 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2022", Category = "Nhà máy công nghiệp", Description = "Dự án trọn gói thiết kế và thi công nhà máy sản xuất bao bì cho Trimas tại VSIP IIA.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "10.000 m²" }, new { label = "Tiêu chuẩn", value = "ISO Class 8" }, new { label = "Thời gian", value = "9 tháng" }, new { label = "Năm", value = "2022" } }), SortOrder = 5 },
            new() { Slug = "nha-kho-apm", ImageUrl = "/images/upload/57ef3e64119d4936b8cf32e59860d7a1.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/c3f099ca5bfe48bbb2e004e3e08545e6.png", "/images/upload/ed71fd3f4482451a987ab2b9b9ed6bbb.png", "/images/upload/60ba8721ed444cb28040800d73d17f43.png" }), Name = "Nhà Kho APM", Client = "Auto Components Việt Nam", Location = "KCN Việt Nam – Singapore, Bình Hòa, Thuận An, Bình Dương", Scale = "6.500 m²", Scope = "Thiết kế", Status = "completed", Year = "2022", Category = "Nhà kho logistics", Description = "Thiết kế nhà kho logistics cho Auto Components Việt Nam.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "6.500 m²" }, new { label = "Chiều cao", value = "12 m" }, new { label = "Dock loading", value = "6" }, new { label = "Năm", value = "2022" } }), SortOrder = 6 },
            new() { Slug = "nha-may-jojo", ImageUrl = "/images/upload/8dd560e0701f4f17b2d26097ecf294ff.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/53f77e3a7b1f4d12bcbfcf52494d335a.png", "/images/upload/65c510a3a6ab4df9ac1acefeb91ea60d.png" }), Name = "Nhà Máy JOJO", Client = "Phạm – Asset", Location = "KCN Hựu Thạnh, Long An", Scale = "7.800 m²", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Nhà máy công nghiệp", Description = "Thiết kế nhà máy sản xuất JOJO với yêu cầu cao về vệ sinh an toàn thực phẩm.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "7.800 m²" }, new { label = "Tiêu chuẩn", value = "HACCP" }, new { label = "Khu sạch", value = "3" }, new { label = "Năm", value = "2024" } }), SortOrder = 7 },
            new() { Slug = "khach-san-d22", ImageUrl = "/images/upload/3e87217f748649dcbc43689df4130a0a.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/85733e2316f34e1597c13519f04f69e3.png", "/images/upload/6de5559076cc47cfac0c1ba8d3c9de30.png" }), Name = "Khách sạn D22", Client = "Nihome", Location = "Thủ Đức, TP.HCM", Scale = "4.500 m²", Scope = "Thiết kế và Thi công", Status = "ongoing", Year = "2024", Category = "Khách sạn", Description = "Khách sạn 4 sao với 80 phòng nghỉ, nhà hàng tầng trệt và khu spa.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "4.500 m²" }, new { label = "Số phòng", value = "80" }, new { label = "Tầng cao", value = "12" }, new { label = "Năm", value = "2024" } }), SortOrder = 8 },
            // ── Ongoing projects from nicon.vn ──
            new() { Slug = "nbdc-canteen", ImageUrl = "/images/upload/c8f4292785a14834857b7c4c742c1198.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/a8761b0c8dbe41f392597ea8cbabeed2.png", "/images/upload/43d1625fb0b841ecb60b3532c72479c0.png" }), Name = "NBDC Canteen", Client = "Công ty TNHH NBDC VN", Location = "KCN Giang Điền, Đồng Nai", Scale = "", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Nhà xưởng sản xuất", Description = "Thiết kế nhà ăn cho khu công nghiệp NBDC tại KCN Giang Điền.", SortOrder = 9 },
            new() { Slug = "nbdc-office", ImageUrl = "/images/upload/9c948a45d7874b9ca9dc41de02c7edbb.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/889f86cb74b643219a339604ab9fb96e.png", "/images/upload/be11137b00b4468ba256506676f63b90.png" }), Name = "NBDC Office", Client = "Công ty TNHH NBDC VN", Location = "KCN Giang Điền, Đồng Nai", Scale = "", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Văn phòng", Description = "Thiết kế văn phòng điều hành cho NBDC tại KCN Giang Điền.", SortOrder = 10 },
            new() { Slug = "nha-may-ttp", ImageUrl = "/images/upload/0a7be7ec9d5e48a081c3347a52436639.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/187172ffce934e30a5074b9c80756a16.png", "/images/upload/f6dcab7718db426381bd33d38e450a1b.png" }), Name = "Nhà Máy Tân Toàn Phát", Client = "Lam Hiệp Hưng & Tân Toàn Phát", Location = "Tỉnh Bình Dương", Scale = "250.000 m²", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Nhà máy công nghiệp", Description = "Nhà máy thuộc tổ hợp Lâm Hiệp Hưng – Tân Toàn Phát tại Bình Dương.", SortOrder = 11 },
            new() { Slug = "nha-may-lhh-2", ImageUrl = "/images/upload/34c7b7b91dfb4e7c9687fe6bac1dea56.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/29e445e1b1c648bc8b704841835adc43.png", "/images/upload/459e134ff5354dc8ad47b5ac7dfdac5b.png" }), Name = "Nhà Máy Lâm Hiệp Hưng", Client = "Lam Hiệp Hưng", Location = "Tỉnh Bình Dương", Scale = "250.000 m²", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Nhà máy công nghiệp", Description = "Nhà máy Lâm Hiệp Hưng tại Bình Dương, mở rộng dây chuyền sản xuất.", SortOrder = 12 },
            // ── Completed projects from nicon.vn ──
            new() { Slug = "nha-may-stfood", ImageUrl = "/images/upload/9032d48581694affb265a7b0eb1c6c07.png", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/15d6908a45644154be120db71aa042da.png", "/images/upload/540c25288eb245a0b3dcd64940fd8b8a.png", "/images/upload/91f729f7ff41471585ea727918f31eef.png" }), Name = "Nhà Máy S.T.Food Marketing Việt Nam", Client = "S.T.FOOD MARKETING Vietnam Co. Ltd.", Location = "Đường 24, VSIP II-A, Tân Uyên, Bình Dương", Scale = "20.000 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2022", Category = "Nhà máy công nghiệp", Description = "Nhà máy sản xuất thực phẩm từ chủ đầu tư Thái Lan, thiết kế theo tiêu chuẩn GMP và HACCP.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "20.000 m²" }, new { label = "Tiêu chuẩn", value = "GMP/HACCP" }, new { label = "Thời gian", value = "14 tháng" }, new { label = "Năm", value = "2022" } }), SortOrder = 13 },
            new() { Slug = "medicare-shop", ImageUrl = "/images/upload/a8f89f2d820c458dae41658611776168.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/b28ef8e3e29442d0abbd1327054caf40.jpg", "/images/upload/1387633a81384484a53b7dd3701b79c7.jpg", "/images/upload/37a71840ee3941a6a13e933e70e84559.jpg" }), Name = "Medicare Shop", Client = "Medicare Company", Location = "G3, Aeon Mall Bình Dương Canary", Scale = "250 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2020", Category = "Thương mại", Description = "Cửa hàng Medicare tại Aeon Mall Bình Dương Canary.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "250 m²" }, new { label = "Vị trí", value = "Aeon Mall" }, new { label = "Năm", value = "2020" } }), SortOrder = 14 },
            new() { Slug = "nha-may-lhh-completed", ImageUrl = "/images/upload/e4529d1421b74ea886c8499cdba8eaa1.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/5af5813659634eeda0682e811413d424.jpg", "/images/upload/8950c862a6e546da9b86f4dd6dc148d1.jpg", "/images/upload/aacb2e8adcf6452c86f2e1c9bebf3acc.jpg" }), Name = "Nhà Máy Lâm Hiệp Hưng (Hoàn thành)", Client = "Lam Hiệp Hưng & Tân Toàn Phát", Location = "Tỉnh Bình Dương", Scale = "18.000 m²", Scope = "Thiết kế", Status = "completed", Year = "2019", Category = "Nhà máy công nghiệp", Description = "Dự án nhà máy Lâm Hiệp Hưng giai đoạn 1 đã hoàn thành.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "18.000 m²" }, new { label = "Năm", value = "2019" } }), SortOrder = 15 },
            new() { Slug = "sctv-office", ImageUrl = "/images/upload/81d639fd0f6c4182a06b8c5a8a130f1b.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/201ffaabff014a76b17aa2bc5a02ec79.jpg" }), Name = "Văn Phòng SCTV", Client = "Đài Truyền hình Cáp Sài Gòn", Location = "Quận 2, TP.HCM", Scale = "4.000 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2020", Category = "Văn phòng", Description = "Thiết kế và thi công văn phòng SCTV tại Quận 2, TP.HCM.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "4.000 m²" }, new { label = "Năm", value = "2020" } }), SortOrder = 16 },
            new() { Slug = "nha-may-hbfuller", ImageUrl = "/images/upload/ff73704dd1f8478aa98034eb4f94f3f6.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/6e367048b1394027ab4d995aa9201bcf.jpg", "/images/upload/b58d6ad3d9444996bf77e115ce128b6a.jpg" }), Name = "Nhà Máy H.B.Fuller", Client = "H.B.Fuller Co., Ltd.", Location = "Tỉnh Bình Dương", Scale = "", Scope = "MEP", Status = "completed", Year = "2019", Category = "Nhà máy công nghiệp", Description = "Thi công hệ thống MEP cho nhà máy H.B.Fuller tại Bình Dương.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Phạm vi", value = "MEP" }, new { label = "Năm", value = "2019" } }), SortOrder = 17 },
            new() { Slug = "red-bull-expansion", ImageUrl = "/images/upload/075cec09e65e47b6988fb72ae31d6618.png", Name = "Dự Án Mở Rộng Red Bull", Client = "Red Bull (Việt Nam) Co., Ltd", Location = "Xa lộ Hà Nội, Bình Thắng, Dĩ An, Bình Dương", Scale = "2.000 m²", Scope = "Thiết kế", Status = "completed", Year = "2024", Category = "Nhà máy công nghiệp", Description = "Thiết kế mở rộng nhà máy Red Bull tại Bình Dương, giữ nguyên bản sắc thương hiệu.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "2.000 m²" }, new { label = "Năm", value = "2024" } }), SortOrder = 18 },
            new() { Slug = "nha-may-great-lotus", ImageUrl = "/images/upload/d95fca1c2c4d4b9fbc2e5b1e43063b7c.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/e0fc580ea0734a0e9f379bdcbe97bb6c.jpg", "/images/upload/11511a61886d42b0be483f111cfb2399.jpg", "/images/upload/b3c45874ec964d67a7d4690fbf6c699e.jpg" }), Name = "Nhà Máy Great Lotus Việt Nam", Client = "Great Lotus Manufacturing Vietnam Co. Ltd.", Location = "VSIP II-A, Tân Uyên, Bình Dương", Scale = "31.187 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2019", Category = "Nhà máy công nghiệp", Description = "Thiết kế và thi công nhà máy Great Lotus với quy mô hơn 31.000 m².", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "31.187 m²" }, new { label = "Năm", value = "2019" } }), SortOrder = 19 },
            new() { Slug = "nha-may-advanced-casting", ImageUrl = "/images/upload/1bd11315312c4601b189049af4eb5913.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/58cef80b50124b50b70a60e3a683967d.jpg", "/images/upload/ab973348fee7450c8e7b44e73dbeed09.jpg" }), Name = "Nhà Máy Advanced Casting Asia", Client = "Advanced Casting Asia Co. Ltd.", Location = "VSIP II-A, Tân Uyên, Bình Dương", Scale = "15.000 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2018", Category = "Nhà máy công nghiệp", Description = "Nhà máy sản xuất Advanced Casting Asia tại VSIP II-A.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "15.000 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 20 },
            new() { Slug = "sctv-studio", ImageUrl = "/images/upload/aa3cbbb4c923410eb574ef8cd9df3f72.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/e3e1458cb3c84ff98d1122455deae861.jpg", "/images/upload/25e7817b8b604fd5aafbeaa2a72bea93.jpg", "/images/upload/02bdac69d52f4f15b77132b10a3f5806.jpg" }), Name = "SCTV Studio & Văn Phòng", Client = "Đài Truyền hình Cáp Sài Gòn", Location = "Quận 2, TP.HCM", Scale = "", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2018", Category = "Studio", Description = "Trường quay truyền hình quy mô lớn nhất Việt Nam tại thời điểm xây dựng.", SortOrder = 21 },
            new() { Slug = "nha-may-bkl", ImageUrl = "/images/upload/47c6724bc94e44b0b8ab622b9cab0668.jpg", Name = "Nhà Máy BKL", Client = "BKL International Ltd., Co", Location = "KCN Thịnh Phát, Bến Lức, Long An", Scale = "5.000 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2018", Category = "Nhà máy công nghiệp", Description = "Thiết kế và thi công nhà máy BKL tại KCN Thịnh Phát.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "5.000 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 22 },
            new() { Slug = "nha-may-rebisco", ImageUrl = "/images/upload/aa42f36eee6f4033acedb0a2b84dacb2.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/9d9492c327814ffc844983271bdecf66.jpg", "/images/upload/0fa2143c80f8401bbf28f213fef1bd71.jpg", "/images/upload/3162e0791f244716a312c26ae7cdcb5b.jpg" }), Name = "Nhà Máy Rebisco", Client = "Republic Biscuit Corporation", Location = "VSIP II-A, Tân Uyên, Bình Dương", Scale = "20.000 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2017", Category = "Nhà máy công nghiệp", Description = "Nhà máy sản xuất bánh kẹo Rebisco (Philippines) tại VSIP II-A.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "20.000 m²" }, new { label = "Năm", value = "2017" } }), SortOrder = 23 },
            new() { Slug = "nha-may-nestle", ImageUrl = "/images/upload/bbc6431f110b4852ad7cbf5340b24c97.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/6f4d7d056cd84228a53c69fd508dcd6e.jpg", "/images/upload/d444fcef93aa45cdaf5002d6212cdfc4.jpg", "/images/upload/486d32ffdf594325836b64d4b25d7654.jpg" }), Name = "Nhà Máy & Văn Phòng Nestlé Bình An", Client = "Nestlé Việt Nam", Location = "KCN Biên Hòa II, Đồng Nai", Scale = "", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2015", Category = "Nhà máy công nghiệp", Description = "Thiết kế và thi công nhà máy và văn phòng Nestlé Bình An.", SortOrder = 24 },
            new() { Slug = "nha-may-ampharco", ImageUrl = "/images/upload/a154bdc70ed149b78dbd2d59076f7c86.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/e528844064a74c05bf145f703573fe47.jpg" }), Name = "Nhà Máy Ampharco U.S.A", Client = "Ampharco U.S.A", Location = "KCN Nhơn Trạch 3, Đồng Nai", Scale = "", Scope = "Thi công", Status = "completed", Year = "2016", Category = "Nhà máy dược phẩm", Description = "Thi công nhà máy dược phẩm Ampharco U.S.A tại Nhơn Trạch.", SortOrder = 25 },
            new() { Slug = "konimiyaki-restaurant", ImageUrl = "/images/upload/9444534c6ffe4adbb01ebf441129da0a.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/e04b5dba4c8046689896cbd3abb94120.jpg", "/images/upload/ecb5b80da1f54b0f9c5a01ebce9da78f.jpg", "/images/upload/60e342d46fff49c098e5d65278f1a0a7.jpg" }), Name = "Nhà Hàng Konimiyaki", Client = "Konimiyaki Restaurant", Location = "Quận 1, TP.HCM", Scale = "400 m²", Scope = "Thiết kế", Status = "completed", Year = "2018", Category = "Nhà hàng", Description = "Thiết kế nhà hàng Konimiyaki tại Quận 1, TP.HCM.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "400 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 26 },
            new() { Slug = "nha-may-scon", ImageUrl = "/images/upload/b4b83d120c2649fbb2b897e4ef4ef135.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/b61c2b070f674501a861639b9c016ec8.jpg", "/images/upload/a4ab73fb3f4d48a28a865bdc22ce3510.jpg", "/images/upload/bb1ae7b843a944eea82eaff8ad7e5fc6.jpg" }), Name = "Nhà Máy SCON", Client = "SCON Co. Ltd.", Location = "VSIP II-A, Tân Uyên, Bình Dương", Scale = "8.337 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2018", Category = "Nhà máy công nghiệp", Description = "Thiết kế và thi công nhà máy SCON tại VSIP II-A.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "8.337 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 27 },
            new() { Slug = "nha-may-clotex", ImageUrl = "/images/upload/f9a71cb5c33b49aea0cb76765e8b4e84.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/2ad483d786f2400bb58508f996523ba1.jpg" }), Name = "Nhà Máy Clotex Labels Việt Nam", Client = "Clotex Labels (VN) Co. Ltd.", Location = "VSIP II-A, Tân Uyên, Bình Dương", Scale = "8.565 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2018", Category = "Nhà máy công nghiệp", Description = "Nhà máy nhãn mác Clotex Labels Vietnam tại VSIP II-A.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "8.565 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 28 },
            new() { Slug = "nha-may-amiba", ImageUrl = "/images/upload/6091b345532b429c8b73b1f9c481621c.jpg", Name = "Nhà Máy Amiba", Client = "Amiba Vietnam Company Limited", Location = "VSIP II-A, Tân Uyên, Bình Dương", Scale = "20.000 m²", Scope = "Thi công", Status = "completed", Year = "2018", Category = "Nhà máy công nghiệp", Description = "Thi công nhà máy Amiba với diện tích 2 hecta tại VSIP II-A.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "20.000 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 29 },
            new() { Slug = "nha-may-akati-wood", ImageUrl = "/images/upload/34f200dd0a50403aa85c02f7f5a0a873.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/b3e0a3e1a35c422db6290eee7adc3621.jpg", "/images/upload/0b7d385feb714ed3960e2aeeb8eb6297.jpg", "/images/upload/e4480d0ab32e41a98a67c6081f4f82da.jpg" }), Name = "Nhà Máy Akati Wood", Client = "Akati Dominant (Malaysia)", Location = "Bình Dương", Scale = "", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2016", Category = "Nhà máy công nghiệp", Description = "Nhà máy gỗ Akati Wood, chi nhánh của Akati Dominant từ Malaysia.", SortOrder = 30 },
            new() { Slug = "nha-may-japan-plus", ImageUrl = "/images/upload/fbbc6e13b7254dbba3dccfccfa79a5cc.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/c8405c40dff440ec8c9ef63b59e4b3af.jpg", "/images/upload/485c2a1255a04ed890cf099ed68573c1.jpg", "/images/upload/bea9a3c7db684d119e6ae4bad4c7b08c.jpg" }), Name = "Nhà Máy Japan Plus", Client = "Japan Plus (Nhật Bản)", Location = "KCN Đông Nam Củ Chi", Scale = "", Scope = "Thi công", Status = "completed", Year = "2016", Category = "Nhà máy công nghiệp", Description = "Nhà máy Japan Plus sản xuất hộp PE tại KCN Đông Nam Củ Chi.", SortOrder = 31 },
            new() { Slug = "duoc-pham-trung-uong", ImageUrl = "/images/upload/579726775ea84f7a9539285d23eb5a83.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/878d15a6338644688b6077aa75ecd118.jpg", "/images/upload/aa53bed5763346168e0c847dd0804311.jpg", "/images/upload/0df5794080b74e6cb593d06d3d5a819b.jpg" }), Name = "Dược Phẩm Trung Ương TP.HCM", Client = "Công ty TNHH Dược Phẩm Trung Ương 1", Location = "TP.HCM", Scale = "", Scope = "Thiết kế", Status = "completed", Year = "2020", Category = "Nhà máy dược phẩm", Description = "Thiết kế nhà máy dược phẩm Trung Ương tại TP.HCM.", SortOrder = 32 },
            new() { Slug = "kumgang-office", ImageUrl = "/images/upload/8f8d5a9e29d740e389fc67bd9491a02c.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/bef0e4618d92473c9b88e4e7c3010132.jpg" }), Name = "Văn Phòng Kumgang", Client = "KUMGANG VINA CO., LTD", Location = "KCN Giang Điền, Trảng Bom, Đồng Nai", Scale = "180 m²", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2018", Category = "Văn phòng", Description = "Thiết kế và thi công văn phòng Kumgang Vina.", HighlightsJson = JsonSerializer.Serialize(new[] { new { label = "Diện tích", value = "180 m²" }, new { label = "Năm", value = "2018" } }), SortOrder = 33 },
            new() { Slug = "nha-may-vda-hcm", ImageUrl = "/images/upload/97210dbad4444e22875aad209d871b09.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/fc66fa412f164bf0bf3aefb58f52a95b.jpg", "/images/upload/8ac5110e93714ba7989b2606df390d03.jpg", "/images/upload/b6cdb80abd5c41a1880d7b65ab41004e.jpg" }), Name = "Nhà Máy VDA-HCM", Client = "VDA-HCM", Location = "KCN Cầu Tràm, Cần Đước, Long An", Scale = "", Scope = "Thiết kế và Thi công", Status = "completed", Year = "2017", Category = "Nhà máy công nghiệp", Description = "Thiết kế và thi công nhà máy VDA-HCM tại KCN Cầu Tràm.", SortOrder = 34 },
            new() { Slug = "thu-thiem-dragon", ImageUrl = "/images/upload/4bcfc13cf0ab46fdbc3816834a91f4dd.jpeg", Name = "Thu Thiêm Dragon Show Flat", Client = "Thu Thiêm Group", Location = "Quận 2, TP.HCM", Scale = "", Scope = "Thi công", Status = "completed", Year = "2015", Category = "Bất động sản", Description = "Thi công căn hộ mẫu Thu Thiêm Dragon tại Quận 2.", SortOrder = 35 },
            new() { Slug = "nha-may-nam-ha-viet", ImageUrl = "/images/upload/58e331acf96b4c68a73a418fd0f9af45.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/b767968f72b444ecbd56f8d3bb85fe55.jpg" }), Name = "Nhà Máy Nam Hà Việt", Client = "Nam Hà Việt Co., Ltd.", Location = "KCN Rạch Bắp, Bến Cát, Bình Dương", Scale = "", Scope = "Thiết kế", Status = "completed", Year = "2020", Category = "Nhà máy công nghiệp", Description = "Nhà máy sản xuất que hàn Nam Hà Việt.", SortOrder = 36 },
            new() { Slug = "nha-may-yc-tec", ImageUrl = "/images/upload/881c2ca41340430aae8e260587abd6b6.jpg", GalleryJson = JsonSerializer.Serialize(new[] { "/images/upload/f778c72dfb6045349c99b6b8b2892058.jpg" }), Name = "Nhà Máy YC TEC", Client = "YC TEC Group", Location = "KCN Sóng Thần II, Dĩ An, Bình Dương", Scale = "", Scope = "Thiết kế", Status = "completed", Year = "2020", Category = "Nhà máy công nghiệp", Description = "Thiết kế nhà máy YC TEC tại KCN Sóng Thần II.", SortOrder = 37 },
            ...
            new() { Slug = "jakob-workshop", ImageUrl = "/images/projects/project-bma.jpg", Name = "Xưởng Jakob (Đề Xuất)", Client = "Jakob", Location = "Bình Dương", Scale = "", Scope = "Thiết kế", Status = "ongoing", Year = "2024", Category = "Nhà máy công nghiệp", Description = "Thiết kế đề xuất xưởng Jakob tại Bình Dương.", SortOrder = 48 },
